        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  _model.detailResponse = await GetProblemDetailTestCall.call(
                    id: int.tryParse(_model.numberController.text),
                  );
                  if ((_model.detailResponse?.succeeded ?? true)) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          (_model.detailResponse?.jsonBody ?? '').toString(),
                          style: TextStyle(
